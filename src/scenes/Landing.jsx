...
const Landing = ({ setSelectedPage }) => {
  ...
  {isAboveLarge ? (
    ...
    >
      <img
        alt="profile"
        className="hover:filter rounded-md hover:saturate-200 transition duration-500 z-10 w-full max-w-[300px] md:max-w-[400px] h-auto"
    ...
    <img
      alt="profile"
      className="z-10 w-full max-w-[300px] md:max-w-[400px] h-auto rounded-md"
      src="assets/profile-min.jpeg"
    />
  )}
</div>
